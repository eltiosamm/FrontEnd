                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    ...
                                    <li className="breadcrumb-item"><a href="/clients">Usuario</a></li>
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="level" className="control-label">Tipo de Usuario</label>
                                        <input type="text" name="text" id="level" className="form-control" required />
                                    </div>
                                </div>
                            </div>
